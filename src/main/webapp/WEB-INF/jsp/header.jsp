...
<nav id='header' class='navbar navbar-expand-lg navbar-light bg-light'>
  <a class='navbar-brand' href='#'>
    <img src='/bitcamp-chopchop/images/choplogo.png' class='d-inline-block align-top' width="100px">
    수업관리시스템
  </a>
...
<c:if test="${empty loginUser}">
  <a href='/app/auth/form' class='btn btn-outline-dark btn-sm'>로그인2</a>
</c:if>
<c:if test="${not empty loginUser}">
  <a href='/app/member/detail?no=${loginUser.no}'>${loginUser.name}</a> 
  <a href='/app/auth/logout' class='btn btn-outline-dark btn-sm'>로그아웃2</a>
</c:if>
  </div>
</nav>
