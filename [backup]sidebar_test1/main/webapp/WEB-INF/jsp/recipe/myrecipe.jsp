...
<body>
	...
	<div class="w3-main w3-content w3-padding" style="max-width: 1200px;">
		<div
			class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 mInfo">
			<h3>My Recipe</h3>
			<span style="float: right; font-size: 14px;"> <a href="">My
					Page</a>&nbsp>&nbspMy Recipe</a></span>
		</div>
